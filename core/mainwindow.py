...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(310, 20, 581, 471))
        self.groupBox_4.setObjectName("groupBox_4")
        self.camera_tab = QtWidgets.QTabWidget(self.groupBox_4)
        self.camera_tab.setGeometry(QtCore.QRect(10, 20, 561, 441))
        self.camera_tab.setObjectName("camera_tab")
        self.widget = QtWidgets.QWidget(Form)
        self.widget.setGeometry(QtCore.QRect(470, 520, 296, 27))
        ...
        self.start_supervision_btn = QtWidgets.QPushButton(self.widget)
